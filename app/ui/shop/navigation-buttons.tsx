  ...
  return (
    <div className="flex h-full w-full flex-row items-center justify-between">
      ...
      <div className="flex flex-row h-5">
        <Link
          href=""
          className="flex h-full px-2 items-center justify-center font-semibold border-r text-[#292929] text-sm after:content-[''] after:absolute
            after:bottom-0 after:left-0 after:w-full after:border-b-2 after:border-[#292929] after:scale-x-0
            after:opacity-50 after:transition-transform after:duration-500 after:ease-in-out hover:after:scale-x-100 hover:after:opacity-100 relative">
          로그인
        </Link>
        <Link
          href=""
          className="flex h-full px-2 items-center justify-center font-semibold text-[#292929] text-sm after:content-[''] after:absolute
            after:bottom-0 after:left-0 after:w-full after:border-b-2 after:border-[#292929] after:scale-x-0
            after:opacity-50 after:transition-transform after:duration-500 after:ease-in-out hover:after:scale-x-100 hover:after:opacity-100 relative">
          회원가입
        </Link>
